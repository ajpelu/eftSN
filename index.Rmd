...
s <- raster::stack(here::here("data/v2/stacks/all_rasters.grd"))
...
#layer_name <- reactiveValues(value=NULL)

# observe({ 
#   variable <- input$selectVariable 
#   year <- input$selectYear
#   
#   layer_name$value <- paste(variable, year, sep = ".")
#   })

rasterInput <- reactive({
  layer_name <- paste0(input$selectVariable, input$selectYear)
