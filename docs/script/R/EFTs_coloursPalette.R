...
# Script para generar la leyenda de colores de EFTs version México. Domingo Alcaraz Segura 16-julio-2015. dalcaraz@ugr.es
# Se pueden cambiar los colores de los EFTs en el objeto EFTColourPalette
...
plot( c(1,colCount), c(0,rowCount), type="n", ylab="", xlab="",
      axes=FALSE, ylim=c(rowCount,0),main=rbind("","","A-D: Productivity (increasing)","a-d: Seasonality (decreasing)","1-4: Phenology (Sp-Sm-Au-Wi)"))
par(cex=1)
j <-1
